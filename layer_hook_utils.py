...
class featureFetcher:
    ...
    """
    # switch device (2) here
    def __init__(self, model, input_size=(3, 256, 256), device="cpu", print_module=True, store_device="cpu"):
...
class featureFetcher_recurrent:
    ...
    """
    # switch device here, self.model = model.to(device)
    def __init__(self, model, input_size=(3, 224, 224), device="cpu", print_module=True):
